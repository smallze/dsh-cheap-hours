...
export function formatPeakWindows(windows: PeakWindow[]): string {
...
export function windowContains(window: PeakWindow, minutes: number): boolean {
...
export function isPeak(date: Date, timeZone: string, windows: PeakWindow[]): boolean {
...
export function zonedWallToDate(timeZone: string, wall: ZonedParts): Date {
...
export function nextOffPeakAt(date: Date, timeZone: string, windows: PeakWindow[]): Date {
